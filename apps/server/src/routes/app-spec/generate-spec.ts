...
Your entire response should be valid JSON starting with { and ending with }. No text before or after.`;
    ...
    // Custom endpoints may not support structured output properly, causing stop hook spam
    ...
    const options = createSpecGenerationOptions({
      ...
      // Only use structured output with official Anthropic endpoint
      // Custom endpoints (GLM, etc.) may not handle stop hooks properly
      ...(!usesCustomEndpoint && {
        outputFormat: {
          type: 'json_schema',
